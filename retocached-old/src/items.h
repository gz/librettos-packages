...
int  do_item_link(item *it, const uint64_t hv);     /** may fail if transgresses limits */
...
item *do_item_touch(const char *key, const size_t nkey, uint64_t exptime, const uint64_t hv, conn *c);
